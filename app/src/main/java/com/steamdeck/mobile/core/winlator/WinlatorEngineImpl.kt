...
class WinlatorEngineImpl @Inject constructor(
  ...
  *
  * Best Practice (2025): Shared default container pattern for efficiency
 ...
 private suspend fun getOrCreateEmulatorContainer(
  ...
  // PRIORITY 2: Use shared default container (recommended for most games)
  // All games share a single Wine prefix unless they have specific requirements
  ...
  // PRIORITY 3: Create default container on first game launch
