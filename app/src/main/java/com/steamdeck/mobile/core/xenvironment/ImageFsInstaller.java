...
import com.steamdeck.mobile.presentation.MainActivity;
import com.steamdeck.mobile.R;
import com.steamdeck.mobile.core.container.Container;
import com.steamdeck.mobile.core.container.ContainerManager;
import com.steamdeck.mobile.core.util.AppUtils;
...
public abstract class ImageFsInstaller {
    ...
    public static void generateCompactContainerPattern(final android.app.Activity activity) {
        AppUtils.keepScreenOn(activity);
